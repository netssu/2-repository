...
module.TraitColors = {
	Common = {
		Gradient = ColorSequence.new({
			ColorSequenceKeypoint.new(0, Color3.new(0.258824, 0.258824, 0.258824));
			ColorSequenceKeypoint.new(0.161, Color3.new(0.705882, 0.705882, 0.705882));
			ColorSequenceKeypoint.new(1, Color3.new(1, 1, 1))}),
		GradientAngle = 90
	},
	Rare = {
		Gradient = ColorSequence.new{ColorSequenceKeypoint.new(0,Color3.new(0.117647, 0.498039, 1)),ColorSequenceKeypoint.new(1,Color3.new(0.12549, 0.592157, 1))},
		GradientAngle = 90
	},
	Epic = {
		Gradient = ColorSequence.new{ColorSequenceKeypoint.new(0,Color3.new(0.403922, 0.168627, 1)),ColorSequenceKeypoint.new(1,Color3.new(0.639216, 0.133333, 1))},
		GradientAngle = 90
	},
	Legendary = {
		Gradient = ColorSequence.new{ColorSequenceKeypoint.new(0,Color3.new(0.992157, 0.658824, 0.0823529)),ColorSequenceKeypoint.new(1,Color3.new(1, 0.921569, 0.0588235))},
		GradientAngle = 90
	},
	Exclusive = {
		Gradient = ColorSequence.new{ColorSequenceKeypoint.new(0,Color3.new(0.541176, 0.313725, 1)),
			ColorSequenceKeypoint.new(1,Color3.new(0.266667, 1, 0.913725))},
		GradientAngle = -20
	},
	Mythical = {
		Gradient = ColorSequence.new{ColorSequenceKeypoint.new(0,Color3.new(1, 0, 0)),
			ColorSequenceKeypoint.new(0.5,Color3.new(1, 0, 1)),
			ColorSequenceKeypoint.new(1,Color3.new(0.505882, 0.231373, 1))},
		GradientAngle = -20
	},
	Secret = {
		Gradient = ColorSequence.new({
			ColorSequenceKeypoint.new(0, Color3.new(1, 0, 0));
			ColorSequenceKeypoint.new(1, Color3.new(1, 0.168627, 0.168627));
		});
		GradientAngle = -20
	},
	Unique = {
		Gradient = ColorSequence.new{
			ColorSequenceKeypoint.new(0,Color3.new(1, 0, 0)),
			ColorSequenceKeypoint.new(0.15,Color3.new(1, 0.478431, 0.129412)),
			ColorSequenceKeypoint.new(0.3,Color3.new(0.92549, 1, 0.109804)),
			ColorSequenceKeypoint.new(0.5,Color3.new(0.184314, 1, 0.0941176)),
			ColorSequenceKeypoint.new(0.65,Color3.new(0.14902, 0.729412, 1)),
			ColorSequenceKeypoint.new(0.8,Color3.new(0.101961, 0.537255, 1)),
			ColorSequenceKeypoint.new(1,Color3.new(0.0980392, 0.294118, 1))},
		GradientAngle = -30
	},
}
